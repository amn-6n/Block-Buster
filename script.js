...
const NAVY =    { r: 0x00, g: 0x00, b: 0x80 };
const MAROON =  { r: 0x80, g: 0x00, b: 0x00 };
const OLIVE =   { r: 0x80, g: 0x80, b: 0x00 };
const SILVER =  { r: 0xc0, g: 0xc0, b: 0xc0 };
const GOLD =    { r: 0xff, g: 0xd7, b: 0x00 };
const INDIGO =  { r: 0x4b, g: 0x00, b: 0x82 };
const VIOLET =  { r: 0x8a, g: 0x2b, b: 0xe2 };
const BROWN =   { r: 0xa5, g: 0x2a, b: 0x2a };
const CORAL =   { r: 0xff, g: 0x7f, b: 0x50 };
const SALMON =  { r: 0xfa, g: 0x80, b: 0x72 };
const PLUM =    { r: 0xdd, g: 0xa0, b: 0xdd };
const KHAKI =   { r: 0xf0, g: 0xe6, b: 0x8c };

const allColors = [
	BLUE, GREEN, PINK, ORANGE, PURPLE, RED, YELLOW, TEAL, WHITE, 
	CYAN, MAGENTA, LIME, NAVY, MAROON, OLIVE, SILVER, GOLD, INDIGO, 
	VIOLET, BROWN, CORAL, SALMON, PLUM, KHAKI
  ];
